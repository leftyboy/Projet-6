...
from modules import get_lda_frequent_tags, mean_local_recall, other_scores, local_recall, get_top_probable_tags
...
print(" Local_Recall moyen sur jeu de TEST : {}".format(multilabel_comparison_df.Local_Recall.mean()))
